...
dendogramCluster = function(ddes, daff, prout){
...
p_prop = "c://Users/aborr/research/Silent_Spring/breast_carcinogen/results/clusterMC/dataset.csv"
...
# dendogram
dendogramCluster(d_desc, d_prop, pr_out)
