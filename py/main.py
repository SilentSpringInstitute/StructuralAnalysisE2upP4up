...
def combineDataset(p_dataset1, p_dataset2, pr_result):

    c_dataset = dataset.dataset(p_dataset1, pr_result)
    return c_dataset.combineDataset(p_dataset2)
...
def analysisDescBasedData(p_dataset, p_desc, p_desc_opera, pr_results, cor_val, max_quantile):


    cAnalysis = analysis.analysis(p_dataset, p_desc, pr_results, cor_val, max_quantile)
    cAnalysis.prepDesc()
