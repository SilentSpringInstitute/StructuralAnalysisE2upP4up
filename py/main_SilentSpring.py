...
# carcinogens - all
##
p_listChem = PR_DATA + "2021_updated_List_MCs_122120.csv"
...
#cChem.analysisDescBasedData(COR_VAL, MAX_QUANTILE, PCA=1, Hclust=1, clustering=0, FP=0, SOM=1, histDesc=1)


# Explore ToxPrint - carcinogen
##
p_ToxPrint = PR_RESULTS + 'comptox/CompToxChemicalsDashboard-Batch-Search_2021-01-06_09_00_11_ToxPrint.csv'
p_chemlist = PR_RESULTS + 'comptox/CompToxChemicalsDashboard-Batch-Search_2021-01-06_09_24_15_chemlist.csv'
